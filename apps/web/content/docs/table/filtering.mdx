...
Both are set up in [Getting Started](/docs/installation). This page explains what they do with your rows.
...
From code, set the search with `table.options.meta.setSearch("…"){:ts}`, and read it from `table.options.meta.search`.

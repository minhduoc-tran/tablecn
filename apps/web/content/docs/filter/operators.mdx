...
`conflict` and `unsupported` come from the serializer: see [Warnings in the UI](/docs/filter/serializers#warnings-in-the-ui). In your own UI, `useRuleWarnings(rule)` returns all three.
